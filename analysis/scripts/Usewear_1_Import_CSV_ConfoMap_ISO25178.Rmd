...
data_final[["Sample"]] <- factor(ifelse(data_final[["Sample"]] %in% c("MU-224", "MU-197", "R-002", "R-006", "R-007", "R-008" ,"R-010" ,"R-013"),  
                                          labels = c("flint", "lydite")))
data_final[["Sample"]] <- factor(ifelse(grepl(pattern = "MU-197|R-002|R-006|R-007|R-008|R-010|R-013", data_final[["Raw.material"]]), "flint", "lydite"))
