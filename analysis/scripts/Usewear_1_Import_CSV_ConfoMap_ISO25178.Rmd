...
#data_final[["Sample"]] <- factor(ifelse(data_final[["Sample"]] == "MU-224", "MU-197", "R-002", "R-006", "R-007", "R-008" ,"R-010" ,"R-013", 
                                 labels = c("flint", "lydite")))

#data.final[["Before.after"]] <- factor(ifelse(data.final[["Mode"]]=="LSM2", "After", "Before"), labels=c("Before","After"))


#MU-197|R-002|R-006|R-007|R-008|R-010|R-013
...
data_final[grepl("MU-003", data_final[["Sample"]]) & grepl("D1", data_final[["Location"]]), "Use-wear.type"] <- "B"
data_final[grepl("MU-008", data_final[["Sample"]]) & grepl("B2", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("MU-020", data_final[["Sample"]]) & grepl("A1", data_final[["Location"]]), "Use-wear.type"] <- "D"
data_final[grepl("MU-020", data_final[["Sample"]]) & grepl("A2", data_final[["Location"]]), "Use-wear.type"] <- "D2"
data_final[grepl("MU-021", data_final[["Sample"]]) & grepl("C3", data_final[["Location"]]), "Use-wear.type"] <- "B"
data_final[grepl("MU-021", data_final[["Sample"]]) & grepl("D1", data_final[["Location"]]), "Use-wear.type"] <- "D2"
data_final[grepl("MU-041", data_final[["Sample"]]) & grepl("D1", data_final[["Location"]]), "Use-wear.type"] <- "E"
data_final[grepl("MU-041", data_final[["Sample"]]) & grepl("D2", data_final[["Location"]]), "Use-wear.type"] <- "E"
data_final[grepl("MU-107", data_final[["Sample"]]) & grepl("B1", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("MU-107", data_final[["Sample"]]) & grepl("D2", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("MU-111", data_final[["Sample"]]) & grepl("B1", data_final[["Location"]]), "Use-wear.type"] <- "E"
data_final[grepl("MU-112", data_final[["Sample"]]) & grepl("C1", data_final[["Location"]]), "Use-wear.type"] <- "E"
data_final[grepl("MU-199", data_final[["Sample"]]) & grepl("A2", data_final[["Location"]]), "Use-wear.type"] <- "E"
data_final[grepl("MU-199", data_final[["Sample"]]) & grepl("C3", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("MU-202", data_final[["Sample"]]) & grepl("C2", data_final[["Location"]]), "Use-wear.type"] <- "A"
data_final[grepl("MU-202", data_final[["Sample"]]) & grepl("D2", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("MU-224", data_final[["Sample"]]) & grepl("D1", data_final[["Location"]]), "Use-wear.type"] <- "B2"
data_final[grepl("MU-224", data_final[["Sample"]]) & grepl("B1", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("MU-232", data_final[["Sample"]]) & grepl("B2", data_final[["Location"]]) & grepl("1", data_final[["Area"]]), "Use-wear.type"] <- "E"
data_final[grepl("MU-232", data_final[["Sample"]]) & grepl("B2", data_final[["Location"]]) & grepl("2", data_final[["Area"]]), "Use-wear.type"] <- "A"
data_final[grepl("MU-197", data_final[["Sample"]]) & grepl("B2", data_final[["Location"]]), "Use-wear.type"] <- "F"
data_final[grepl("MU-197", data_final[["Sample"]]) & grepl("D3", data_final[["Location"]]), "Use-wear.type"] <- "F"
data_final[grepl("MU-240", data_final[["Sample"]]) & grepl("C2", data_final[["Location"]]), "Use-wear.type"] <- "C+A"
data_final[grepl("MU-240", data_final[["Sample"]]) & grepl("D1", data_final[["Location"]]), "Use-wear.type"] <- "F"
data_final[grepl("MU-246", data_final[["Sample"]]) & grepl("D1", data_final[["Location"]]), "Use-wear.type"] <- "C/E"
data_final[grepl("MU-273", data_final[["Sample"]]) & grepl("B3", data_final[["Location"]]), "Use-wear.type"] <- "C/E"
data_final[grepl("MU-019", data_final[["Sample"]]) & grepl("A3", data_final[["Location"]]), "Use-wear.type"] <- "B2"
data_final[grepl("MU-025", data_final[["Sample"]]) & grepl("B2", data_final[["Location"]]), "Use-wear.type"] <- "B"
data_final[grepl("MU-279", data_final[["Sample"]]) & grepl("C2", data_final[["Location"]]), "Use-wear.type"] <- "C"

# add the use-wear type - Ramioul 
data_final[grepl("R-002", data_final[["Sample"]]) & grepl("A1", data_final[["Location"]]), "Use-wear.type"] <- "D"
data_final[grepl("R-006", data_final[["Sample"]]) & grepl("C3", data_final[["Location"]]), "Use-wear.type"] <- "E"
data_final[grepl("R-007", data_final[["Sample"]]) & grepl("C2", data_final[["Location"]]), "Use-wear.type"] <- "G"
data_final[grepl("R-008", data_final[["Sample"]]) & grepl("C1", data_final[["Location"]]), "Use-wear.type"] <- "D"
data_final[grepl("R-020", data_final[["Sample"]]) & grepl("C2", data_final[["Location"]]), "Use-wear.type"] <- "A"
data_final[grepl("R-020", data_final[["Sample"]]) & grepl("C3", data_final[["Location"]]), "Use-wear.type"] <- "G"
data_final[grepl("R-010", data_final[["Sample"]]) & grepl("B2", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("R-010", data_final[["Sample"]]) & grepl("C1", data_final[["Location"]]), "Use-wear.type"] <- "C/E"
data_final[grepl("R-013", data_final[["Sample"]]) & grepl("C1", data_final[["Location"]]), "Use-wear.type"] <- "G"
data_final[grepl("R-013", data_final[["Sample"]]) & grepl("C3", data_final[["Location"]]), "Use-wear.type"] <- "D2"

# add the use-wear type - Buhlen
data_final[grepl("BU-003", data_final[["Sample"]]) & grepl("C1", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("BU-032", data_final[["Sample"]]) & grepl("B3", data_final[["Location"]]), "Use-wear.type"] <- "D2"
data_final[grepl("BU-077", data_final[["Sample"]]) & grepl("B3", data_final[["Location"]]), "Use-wear.type"] <- "C/E"
data_final[grepl("BU-173", data_final[["Sample"]]) & grepl("C2", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("BU-128", data_final[["Sample"]]) & grepl("D2", data_final[["Location"]]), "Use-wear.type"] <- "C"
data_final[grepl("BU-115", data_final[["Sample"]]) & grepl("A2", data_final[["Location"]]), "Use-wear.type"] <- "C"
...
```{r}
data_final <- data_final[c(53, 1, 3:5, 2, 8, 6:7, 9:52)]
```
